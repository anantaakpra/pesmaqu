            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-8 border border-gray-200">
                ...
                <form action="/berita" method="POST">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" name="title" class="shadow-sm border-gray-300 rounded w-full py-2 px-3 bg-white text-gray-900 focus:ring focus:ring-blue-200" required>
                    </div>
                    
                    <div class="mb-6">
                        <label class="block text-gray-700 text-sm font-bold mb-2">Link Gambar (URL)</label>
                        <input type="url" name="image_url" placeholder="https://sumber-gambar.com/foto.jpg" class="shadow-sm border-gray-300 rounded w-full py-2 px-3 bg-white text-gray-900 focus:ring focus:ring-blue-200" required>
                    </div>
                    
                    <div class="mb-6">
                        <label class="block text-gray-700 text-sm font-bold mb-2">Isi Berita</label>
                        <textarea name="content" rows="6" class="shadow-sm border-gray-300 rounded w-full py-2 px-3 bg-white text-gray-900 focus:ring focus:ring-blue-200" required></textarea>
                    </div>
