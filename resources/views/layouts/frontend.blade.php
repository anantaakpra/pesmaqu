...
<body class="font-sans antialiased bg-base-100">
    ...
    <div class="navbar bg-white shadow-sm sticky top-0 z-50 h-20">
        <div class="container mx-auto px-4 h-full flex justify-between items-center relative">

            <div class="flex items-center h-full flex-shrink-0 z-10">
            ...
            <div class="hidden lg:flex items-center justify-center gap-8 font-semibold text-gray-600 h-full absolute left-1/2 -translate-x-1/2">
            ...
            <div class="hidden lg:flex items-center h-full flex-shrink-0 z-10">
                <a href="/ppdb" class="bg-[#bf9000] hover:bg-[#a37a00] text-white font-bold py-2 px-6 rounded-full shadow-md transition duration-300">
                    PPDB Online
                </a>
            </div>

            <div class="lg:hidden flex items-center justify-end h-full flex-shrink-0 z-10">
                <button id="menuButton" class="text-3xl text-gray-500 hover:text-[#bf9000] p-2 focus:outline-none select-none flex items-center justify-center">
                    &#8942;
                </button>
            </div>
        ...
        <div id="mobileMenu" class="hidden absolute top-20 left-0 w-full bg-white shadow-xl flex-col gap-4 pb-5 px-6 font-medium text-gray-700 border-t border-gray-100 pt-4 z-40">
