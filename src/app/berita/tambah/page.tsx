        ...
        <div className="bg-white rounded-3xl shadow-sm border border-slate-100 p-8 md:p-10">
          <div className="mb-8 border-b border-slate-100 pb-5">
            ...
            <p className="text-xs text-slate-500 mt-1">
              Publikasikan informasi dan kegiatan terkini untuk ditampilkan di beranda dan halaman berita.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                placeholder="Contoh: Penerimaan Beasiswa Santri Baru Tahun Akademik 2026/2027"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="https://images.unsplash.com/photo-... atau URL gambar langsung"
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Tuliskan isi informasi, pengumuman, atau artikel selengkapnya di sini..."
            ...
            <div className="pt-4 border-t border-slate-100 flex items-center justify-between">
              ...
              <button
                type="submit"
                disabled={loading}
                className="bg-[#bf9000] hover:bg-[#a37a00] disabled:bg-gray-400 text-white font-bold py-3 px-8 rounded-xl shadow-md hover:shadow-lg transition duration-200 flex items-center gap-2 text-sm"
              >
                {loading ? (
                  <>
